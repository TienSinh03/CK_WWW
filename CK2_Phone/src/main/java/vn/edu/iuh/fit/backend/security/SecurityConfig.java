...
public class SecurityConfig {
    ...
    /**
     * Create a user with username, password, and role not from database
     * from in-memory
     * @param encoder
     * @return
     */
...
//    }
    ...
    @Bean
    public DaoAuthenticationProvider daoAuthenticationProvider(UserDetailService userDetailService) {
